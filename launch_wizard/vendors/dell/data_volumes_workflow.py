"""
Data volumes workflow implementation for Dell storage devices.

This module contains the vendor-specific implementation of the data volumes workflow
for Dell storage devices.
"""
...
def execute_data_volumes_workflow(
    ...
    dell_management_ip: str,
    dell_username: str,
    dell_password: str,
) -> Optional[str]:
    """
    Execute a data volumes workflow for Dell and return the generated user data.

    This function leverages the existing Dell workflow by calling it with a secondary context configured for data volumes.

    Args:
        ctx: The original workflow context.
        default_protocol: The default storage protocol to use.
        dell_management_ip: Dell management IP address.
        dell_username: Dell username.
        dell_password: Dell password.
    ...
    try:
        # Import the Dell iSCSI and NVMe workflow functions
        ...
        # Call the existing Dell iSCSI or NVMe workflow with data volumes context
        # This will automatically handle all the Dell-specific logic without duplication
