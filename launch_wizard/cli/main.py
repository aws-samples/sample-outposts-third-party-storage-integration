...
from launch_wizard.vendors.dell import dell_app
from launch_wizard.vendors.generic import generic_app
from launch_wizard.vendors.hpe import hpe_app
...
def create_app() -> typer.Typer:
    ...
    cli_app.add_typer(dell_app, name="dell", help="Dell storage array integration")
    cli_app.add_typer(generic_app, name="generic", help="Generic storage array integration")
    cli_app.add_typer(hpe_app, name="hpe", help="HPE storage array integration")
